"""
Django settings for DjangoTrainingProgram project.
...
SECRET_KEY = 'django-insecure-+ll5jopks5a(%swjd7s=0x6p5b1)ynz9s*2ax$b+tb(-3qxv*y'
...
ROOT_URLCONF = 'DjangoTrainingProgram.urls'
...
WSGI_APPLICATION = 'DjangoTrainingProgram.wsgi.application'
...
# Cấu hình để Django biết cách gửi email
...
ADMINS = [
    ('admin', 'hungmanh2607uitvnu@gmail.com'),
]